...
/*
Lista Encadeada: Uma lista encadeada é uma estrutura de dados dinâmica composta por nós, onde cada nó contém um dado e um ponteiro para o próximo nó na sequência.
...
Remoção: A função remover remove um nó com um valor específico da lista.
